...
@section("main-content")
    ...
    <div class="row">
        <div class="container col-sm-12 col-md-12">
            {!! Form::model($book, array('class' => 'form-horizontal', 'role' => 'form', 'route' => array('admin.books.update', $book->id), 'method' => 'put', 'enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        {!! Form::select('genres[]', $genres, $book->genres, array('class' => 'form-control', 'id' => 'genre', 'multiple')) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        {!! Form::input('number', 'amount', null, array('min' => 1, 'class' => 'form-control', 'placeholder' => 'Antal')) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-4"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        {!! Form::submit('Spara', array('class' => 'btn btn-primary btn-lg btn-block')) !!}
                    </div>
                </div>
            {!! Form::close() !!}
        </div>
